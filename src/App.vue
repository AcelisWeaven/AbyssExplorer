<template>
  ...
  >
    ...
    <div
      v-if="swUpdateExists"
      class="red-line update-available"
    >
    ...
    <div class="columns">
      <div class="large">
        <h1 class="red-line">
          ABYSS <span class="pink">EXPLORER</span>
        </h1>
      </div>
    ...
    <div class="columns">
      ...
      <div class="aside narrow">
        <button
          v-if="!isAppInstalled && appDeferredPrompt !== null"
          class="button-pink"
        ...
        <div class="filter">
          ...
          <div class="select">
            ...
            >
              ...
              <optgroup
                v-for="(tagGroup, tagGroupIndex) in tagGroups"
                :key="tagGroupIndex"
                :label="tagGroup.name"
              >
                <option
                  v-for="key in tagGroup.tags"
                  :key="key"
                  :value="key"
                >
                  {{ tags[key].name }}
